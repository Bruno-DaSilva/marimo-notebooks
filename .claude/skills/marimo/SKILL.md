---
name: marimo
description: Guide for creating and editing marimo reactive notebooks. Use when working with marimo cells, UI elements, altair charts, or data science workflows.
user-invocable: true
